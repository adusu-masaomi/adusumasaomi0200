class OutsourcingCostsController < ApplicationController
  ...
  def update_purchase_data_payment_flag
    ...
    #支払日入力有、支払金額有、未払金額無しの場合のみ、支払いフラグを更新。
  ...
  private
    ...
    def outsourcing_cost_params
      params.require(:outsourcing_cost).permit(:construction_datum_id, :staff_id, :purchase_amount, :supplies_expense, :labor_cost, :misellaneous_expense, :execution_amount, :billing_amount, :purchase_order_amount, :closing_date, :payment_amount, :unpaid_amount, :payment_due_date, :payment_date)
    end
end
