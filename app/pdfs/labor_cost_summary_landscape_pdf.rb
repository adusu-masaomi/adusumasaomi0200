class LaborCostSummaryLandscapePDF
    
  
  def self.create labor_cost_summary_landscape
	#労務集計表(横)PDF発行
      ...
      # tlfファイルを読み込む
      #report = ThinReports::Report.new(layout: "#{Rails.root}/app/pdfs/labor_cost_summary_landscape_pdf.tlf")
      report = Thinreports::Report.new(layout: "#{Rails.root}/app/pdfs/labor_cost_summary_landscape_pdf.tlf")
