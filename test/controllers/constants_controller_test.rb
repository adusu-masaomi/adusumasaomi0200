...
class ConstantsControllerTest < ActionController::TestCase
  ...
  test "should create constant" do
    assert_difference('Constant.count') do
      post :create, constant: { purchase_order_last_header_code: @constant.purchase_order_last_header_code }
    end
  ...
  test "should update constant" do
    patch :update, id: @constant, constant: { purchase_order_last_header_code: @constant.purchase_order_last_header_code }
    assert_redirected_to constant_path(assigns(:constant))
  end
